...
Tener docker desktop instalado. Una vez instalado correr el siguiente código en el directorio donde tenemos clonado el proyecto

NOTA ANTES DE EJECUTAR EL COMANDO DOCKER:  "C:/ruta/openapi.yaml", ruta se debe modificar por la ruta del proyecto.
